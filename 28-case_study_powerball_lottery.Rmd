...
```{r nice-fig-1734, fig.cap='Powerball Logo', out.width='60%', fig.asp=.75, fig.align='center', echo=FALSE}
...
```{r nice-fig-1735, fig.cap='Ways to Win Powerball', out.width='90%', fig.asp=.75, fig.align='center', echo=FALSE}
