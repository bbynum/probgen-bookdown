...
Venn Diagrams are a helpful way to visualize the relationships between overlapping events. Two overlapping events may be represented in a Venn diagram with two overlapping circles. Think of the rectangle containing them as the entire sample space.
...
### Exercise - Venn for Three
Consider the generic Venn diagram for three overlapping events - A, B, C - given below. Identify the event associated with each region (For example, region 2 is **A and B and not C**).
