...
```{r nice-tab-11, tidy=FALSE}
die <- sample(x=c(1,2,3,4,5,6), size=10000, replace = TRUE)
sim_die <- data.frame(die)
knitr::kable(
  table(sim_die), caption = 'Table 1: Tossing One Die Simulation',
  booktabs = TRUE
)
```
...
```{r nice-fig-12, fig.cap='Histogram for Tossing One Die', out.width='80%', fig.asp=.75, fig.align='center'}
