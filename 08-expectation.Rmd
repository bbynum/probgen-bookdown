...
$$Mean=\sum_{x} x \cdot P(x)= \\(-1) \cdot (125/216)+1 \cdot (75/216) +2 \cdot (15/216)+3 \cdot (1/216)=-17/216=-0.0787 $$
...
Given the suitcase amounts `suitcases` and the mean `deal_mean` and the probabilities `probs` we can easily compute the variance and standard deviation.

```{r}
deal_var <- sum((suitcases-deal_mean)^{2}*probs)
deal_var
...
new_deal_mean <- sum(suitcases*probs)
new_deal_mean
```
