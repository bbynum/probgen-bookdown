...
knitr::include_graphics("01-basics-figures/venn_class_composition.png")
```
...
```{r nice-fig-53, fig.cap='Venn Diagram of Paying Taxes', out.width='30%', fig.asp=.75, fig.align='center', echo=FALSE}
