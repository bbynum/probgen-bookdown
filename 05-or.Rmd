...
```{r nice-fig-51, fig.cap='Venn Diagram of Class Composition', out.width='30%', fig.asp=.75, fig.align='center', echo=FALSE}
...
```{r nice-fig-52, fig.cap='Venn Diagram of Three Events', out.width='30%', fig.asp=.75, fig.align='center', echo=FALSE}
...
```{r nice-fig-53, fig.cap='Venn Diagram for Three Sports', out.width='30%', fig.asp=.75, fig.align='center', echo=FALSE}
...
```{r nice-fig-54, fig.cap='Venn Diagram of Paying Taxes', out.width='30%', fig.asp=.75, fig.align='center', echo=FALSE}
