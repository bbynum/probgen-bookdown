...
```{r nice-fig-503, fig.cap='Venn Diagram Event Description', out.width='30%', fig.asp=.75, fig.align='center', echo=FALSE}
...
```{r nice-fig-504, fig.cap='Partially Completed Venn Diagram for Three Sports', out.width='30%', fig.asp=.75, fig.align='center', echo=FALSE}
...
```{r nice-fig-505, fig.cap='Venn Diagram of Paying Taxes', out.width='30%', fig.asp=.75, fig.align='center', echo=FALSE}
