...
```{r nice-fig-134, fig.cap='Simpler Ant-walking Grid with Labels', out.width='30%', fig.asp=.75, fig.align='center', echo=FALSE}
...
```{r nice-fig-135, fig.cap='Simpler Ant-walking Grid Solutions with Orderings', out.width='30%', fig.asp=.75, fig.align='center', echo=FALSE}
