...
```{r nice-fig-72, fig.cap='Decision Table', out.width='30%', fig.asp=.75, fig.align='center', echo=FALSE}
...
```{r nice-fig-73, fig.cap='Drug Testing Tree Diagram', out.width='30%', fig.asp=.75, fig.align='center', echo=FALSE}
...
```{r nice-fig-74, fig.cap='Hypothetical 10,000 Table', out.width='30%', fig.asp=.75, fig.align='center', echo=FALSE}
