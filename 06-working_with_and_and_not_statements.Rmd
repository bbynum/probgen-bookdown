...
```{r nice-fig-603, fig.cap='Tree Diagram for Game One', out.width='30%', fig.asp=.75, fig.align='center', echo=FALSE}
...
```{r nice-fig-604, fig.cap='Venn Diagram of Class Composition', out.width='30%', fig.asp=.75, fig.align='center', echo=FALSE}
...
```{r nice-fig-605, fig.cap='Tree Diagram for Birthday Problem', out.width='30%', fig.asp=.75, fig.align='center', echo=FALSE}
